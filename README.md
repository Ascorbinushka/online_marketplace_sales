...
scheduler.py — полностью настроенный DAG для Apache Airflow, обеспечивающий гибкость в управлении и мониторинге задач.

scheduler_cron.py — альтернативный вариант, который необходимо запускать вручную через cron, предлагая более простой, но менее интерактивный способ автоматизации.
